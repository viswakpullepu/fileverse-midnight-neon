...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fa(){return new Er({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:La(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ia(){return new Er({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:La(),fragmentShader:`
